...
START TRANSACTION;
USE `slaskdb`;
INSERT INTO `slaskdb`.`role` (`idRole`, `rolename`) VALUES (1, 'ROLE_ADMIN');
INSERT INTO `slaskdb`.`role` (`idRole`, `rolename`) VALUES (2, 'ROLE_USER');
INSERT INTO `slaskdb`.`role` (`idRole`, `rolename`) VALUES (3, 'ROLE_CODER');
...
START TRANSACTION;
USE `slaskdb`;
INSERT INTO `slaskdb`.`game` (`idGame`, `game_code`, `session_id`, `game_name`, `user_status`, `club_idClub`, `user_idUser`) VALUES (1, '1', '1', 'mCzarny', 1, 1, 1);
INSERT INTO `slaskdb`.`game` (`idGame`, `game_code`, `session_id`, `game_name`, `user_status`, `club_idClub`, `user_idUser`) VALUES (2, '1', '2', 'jBednarczyk', 0, 2, 2);
