...
START TRANSACTION;
USE `slaskdb`;
INSERT INTO `slaskdb`.`user` (`idUser`, `name`, `sname`, `login`, `password`, `enabled`, `club_idClub`) VALUES (1, 'Mariusz', 'Czarny', 'mczarny', '123', 1, 1);
INSERT INTO `slaskdb`.`user` (`idUser`, `name`, `sname`, `login`, `password`, `enabled`, `club_idClub`) VALUES (2, 'Jacek', 'Bednarczyk', 'jbednarczyk', '123', 1, 2);
INSERT INTO `slaskdb`.`user` (`idUser`, `name`, `sname`, `login`, `password`, `enabled`, `club_idClub`) VALUES (3, 'Jan', 'Kowalski', 'jkowalski', '123', 0, 2);
COMMIT;
