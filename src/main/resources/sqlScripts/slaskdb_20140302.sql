...
CREATE TABLE IF NOT EXISTS `slaskdb`.`finance` (
  ...
  `Budget` INT(11) NULL,
  `TransferBudget` INT(11) NULL DEFAULT NULL,
  `WageBudget` INT(11) NULL DEFAULT NULL,
  `StadiumCost` INT(11) NULL DEFAULT NULL,
  `AvgTicketCost` INT(11) NULL DEFAULT NULL,
  `AvgSeasonTicketCost` INT(11) NULL DEFAULT NULL,
  `SeasonTicketsNumber` INT(11) NULL DEFAULT NULL,
  `Dept` INT(11) NULL DEFAULT NULL,
  `FromSponsors` INT(11) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `slaskdb`.`tactic` (
  `idTactic` INT(11) NOT NULL AUTO_INCREMENT,
  `Attack` INT(11) NULL,
  `Marking` INT(11) NULL DEFAULT NULL,
  `Offside` INT(11) NULL DEFAULT NULL,
  `Pressing` INT(11) NULL DEFAULT NULL,
  `Tempo` INT(11) NULL DEFAULT NULL,
  `PlayWide` INT(11) NULL DEFAULT NULL,
  `PlayHigh` INT(11) NULL DEFAULT NULL,
  `Flair` INT(11) NULL DEFAULT NULL,
  `LongPass` INT(11) NULL DEFAULT NULL,
  `PlayToDefenders` INT(11) NULL DEFAULT NULL,
  `TacticName` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `slaskdb`.`formation` (
  ...
  `DefendersNumber` INT(1) NULL DEFAULT NULL,
  `MidfieldNumber` INT(1) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `slaskdb`.`coach` (
  ...
  `TreningMental` INT(11) NULL DEFAULT NULL,
  `TreningTactic` INT(11) NULL DEFAULT NULL,
  `TreningTechnique` INT(11) NULL DEFAULT NULL,
  `Motivating` INT(11) NULL DEFAULT NULL,
  `Management` INT(11) NULL DEFAULT NULL,
  `Discipline` INT(11) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `slaskdb`.`tournament` (
  ...
  `TournamentReputation` INT(11) NULL DEFAULT NULL,
  `TeamsNumber` INT(11) NULL DEFAULT NULL,
  `RelegatesNumber` INT(11) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `slaskdb`.`stadium` (
  ...
  `YearBuild` YEAR NULL DEFAULT NULL,
  `Modernity` INT(11) NULL DEFAULT NULL,
  `FieldWidth` INT(11) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `slaskdb`.`training` (
  ...
  `TrainingName` VARCHAR(45) NULL DEFAULT NULL,
  `Pace` TINYINT(1) NULL,
  `Strength` TINYINT(1) NULL,
  `Stamina` TINYINT(1) NULL,
  `SetPieces` TINYINT(1) NULL,
  `Technique` TINYINT(1) NULL,
  `Finishing` TINYINT(1) NULL,
  `Passing` TINYINT(1) NULL,
  `Marking` TINYINT(1) NULL,
  `Tackling` TINYINT(1) NULL,
  `Heading` TINYINT(1) NULL,
  `Reflex` TINYINT(1) NULL,
  `Handling` TINYINT(1) NULL,
...
CREATE TABLE IF NOT EXISTS `slaskdb`.`club` (
  ...
  `AttendanceMin` INT(11) NULL DEFAULT NULL,
  `AttendanceMax` INT(11) NULL DEFAULT NULL,
  `TrainingAssets` INT(11) NULL DEFAULT NULL,
  `Youth` INT(11) NULL DEFAULT NULL,
  `ClubName` VARCHAR(45) NULL DEFAULT NULL,
  `ClubNick` VARCHAR(45) NULL DEFAULT NULL,
  `YearFound` YEAR NULL DEFAULT NULL,
  `Morale` INT(11) NULL DEFAULT NULL,
  `ClubReputation` INT(11) NULL DEFAULT NULL,
  `Colours` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `slaskdb`.`position` (
  ...
  `DefenderLeft` INT(11) NULL DEFAULT NULL,
  `DefenderCenter` INT(11) NULL DEFAULT NULL,
  `DefenderRight` INT(11) NULL DEFAULT NULL,
  `MidfieldDef` INT(11) NULL DEFAULT NULL,
  `MidfieldRight` INT(11) NULL DEFAULT NULL,
  `MidfieldLeft` INT(11) NULL DEFAULT NULL,
  `MidfieldCenter` INT(11) NULL DEFAULT NULL,
  `WingerLeft` INT(11) NULL DEFAULT NULL,
  `WingerRight` INT(11) NULL DEFAULT NULL,
  `Forward` INT(11) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `slaskdb`.`player` (
  ...
  `LegLeft` INT(11) NULL DEFAULT NULL,
  `LegRight` INT(11) NULL DEFAULT NULL,
  `Determination` INT(11) NULL DEFAULT NULL,
  `Dirtness` INT(11) NULL DEFAULT NULL,
  `Influence` INT(11) NULL DEFAULT NULL,
  `Injury` INT(11) NULL DEFAULT NULL,
  `Pace` INT(11) NULL DEFAULT NULL,
  `Strength` INT(11) NULL DEFAULT NULL,
  `Stamina` INT(11) NULL DEFAULT NULL,
  `SetPieces` INT(11) NULL DEFAULT NULL,
  `Technique` INT(11) NULL DEFAULT NULL,
  `Finishing` INT(11) NULL DEFAULT NULL,
  `Passing` INT(11) NULL DEFAULT NULL,
  `Marking` INT(11) NULL DEFAULT NULL,
  `Tackling` INT(11) NULL DEFAULT NULL,
  `Heading` INT(11) NULL DEFAULT NULL,
  `Reflex` INT(11) NULL DEFAULT NULL,
  `Handling` INT(11) NULL DEFAULT NULL,
  `Weight` INT(11) NULL DEFAULT NULL,
  `Height` INT(11) NULL DEFAULT NULL,
  `BestPosition` VARCHAR(45) NULL DEFAULT NULL,
  `BestPositionShort` VARCHAR(45) NULL DEFAULT NULL,
  `person_idPerson` INT(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `slaskdb`.`referee` (
  ...
  `Refereeing` INT(11) NULL DEFAULT NULL,
  `Punishing` INT(11) NULL DEFAULT NULL,
  `person_idPerson` INT(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `slaskdb`.`arrange` (
  `idArrange` INT(11) NOT NULL AUTO_INCREMENT,
