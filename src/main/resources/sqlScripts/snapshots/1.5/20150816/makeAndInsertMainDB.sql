...
START TRANSACTION;
USE `databaseInstance`;
INSERT INTO `databaseInstance`.`turn` (`idTurn`, `status_owner`, `status_rival`) VALUES (1, '1', '1', 'mariuszGra', 1, 1, 1);
INSERT INTO `databaseInstance`.`turn` (`idTurn`, `status_owner`, `session_id`) VALUES (2, '1', '2', 'jacekGra', 0, 2, 2);
